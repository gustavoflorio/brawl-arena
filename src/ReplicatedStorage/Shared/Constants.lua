...
local Constants = {
	...
	Rank = {
		Tiers = {
			...
			{ name = "Diamond I",    threshold = 5400 },
			{ name = "Diamond II",   threshold = 6500 },
			{ name = "Diamond III",  threshold = 7800 },
			{ name = "Champion",     threshold = 10000 },
		},
		PointsPerKill = 15,
		PointsLostPerDeath = 7,
		DivisionBonusPercent = 0.10,
	},
	Streak = {
		DoubleWindow = 5.0,
		TripleWindow = 8.0,
